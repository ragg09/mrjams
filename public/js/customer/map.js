        ...
        if (navigator.geolocation) {
          ...
          $.each(data.data, function(key, val){
              // console.log(val.latitude);
                ...
                const contentString = "<section class='about'><p style='font-size:25px; margin-bottom:3px; color: #6497B1; font-weight:bold;'>"+val.name+"</p><p style='font-size:15px; margin-bottom:3px; font-weight:bold;'><b>"+val.type+" Clinic</b></p><p style='font-size:13px; margin-bottom:3px;'><b>Address:</b>"+ val.address_line_1 +" "+ val.address_line_2 +" ,<br>"+ val.city +" "+ val.zip_code +"</p><p style='font-size:13px; margin-bottom:3px;'><b>Phone: </b>"+val.phone+"</p><a class='btn btn-light' href='/customer/appointment/"+val.id+"' style='color: black; font-size:12px;'>View More</a></section>";
