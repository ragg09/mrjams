<form action="/clinic/settings/{{ $general->id }}_AddSpecialists" method="POST" id="add_specialist_form">
    @csrf
    {{ method_field('PUT') }}
    <div class="modal fade" id="create_specialists_modal" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="10" min="0" max="50" class="form-control"
                            id="compensation_rate" name="compensation_rate" placeholder="Enter percentage per service">
