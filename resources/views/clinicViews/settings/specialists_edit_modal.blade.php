                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="time" id="edit_specialist_min_time" name="min_time">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="time" id="edit_specialist_max_time" name="max_time">
