...
@section('content')
    ...
    <form action="/clinic/billing/{{ $complete_summary->ro_id }}" method="POST" id="finish_appointment_form">
        ...
        <div class="row">
            <div class="col-lg-6  p-3">
                <div class="rounded p-3" id="box">
                    ...
                    <h6><i class="fa fa-wrench" aria-hidden="true"></i> Tools & Equipments<p class="mx-5"
                            style="font-size: 13px">(Please double check this portion for accurate inventory management.)
                        </p>
                    </h6>
                    <div class="mx-auto w-75">
                        <div class="row">
                            ...
                            <div class="overall_equipments">
                                @foreach ($complete_equipments as $row)
                                    @if ($row->max_quantity > 0)
                                        <div class="row">
                                            <div class="col">
                                                <p>{{ $row->name }} ({{ $row->unit }})</p>
                                            </div>
                                            <div class="col"><input type="number" class=" positive-numeric-only"
                                                    min="0" max="{{ $row->max_quantity }}"
                                                    value="{{ $row->min_quantity }}" id="equipment_values"
                                                    name="equipment_values"></div>
                                        </div>
                                    @endif
                                @endforeach
            ...
            <div class="col-lg-6  p-3">
                <div class="rounded p-3" id="box">
                    ...
                    <div class="">
                        ...
                        <button type="button" class="btn btn-outline-success mx-auto d-block" data-bs-toggle="modal"
                            data-bs-target="#additionals_modal" id="open_additionals_modal">
                            <i class="fas fa-plus"></i>
                        </button>
                    </div>
                    ...
                    <div class="mx-auto w-75">
                        <div class="form-group">
                            {{-- <p><i class="fa fa-circle" aria-hidden="true"></i> <span class="mx-1"
                                    style="font-size: 13px">(can be both)</span></p> --}}

                            <div class="form-check form-check-inline">
                                <input type="checkbox" class="btn-check" id="cash_payment" name="z_cash_payment"
                                    autocomplete="off">
                                <label class="btn btn-outline-primary" for="cash_payment"> <i class="fa fa-money-bill mx-2"
                                        aria-hidden="true"></i>Cash Payment</label>

                                <div hidden>
                                    <input type="checkbox" class="btn-check" id="card_payment" name="z_card_payment"
                                        autocomplete="off">
                                    <label class="btn btn-outline-primary" for="card_payment"><i
                                            class="fa fa-credit-card mx-2" aria-hidden="true"></i>Card Payment</label>
                                </div>

                                <div class="form-floating mt-1" id="paid_in_cash_div" hidden>
                                    <input type="text" class="form-control" id="paid_in_cash" name="z_paid_in_cash"
                                        value="0">
                                ...
                                <select class="form-select mt-1" id="select_card" name="z_select_card" hidden>
                                    ...
                                    <option value="Asalus Corporation (Intellicare)">Asalus Corporation (Intellicare)
                                    </option>
                                    ...
                                    <option value="CareHealth Plus Systems International, Inc.">CareHealth Plus Systems
                                        International, Inc.</option>
                                    ...
                                    <option value="Cooperative Health Management Federation (CHMF)">Cooperative Health
                                        Management Federation (CHMF)</option>
                                    ...
                                    <option value="Health Care & Dev Corp of the Philippines (HC&D)">Health Care & Dev Corp
                                        of the Philippines (HC&D)</option>
                                    <option value="Health Maintenance, Inc. (HMI)">Health Maintenance, Inc. (HMI)</option>
                                    <option value="Health Plan Philippines, Inc. (HPPI)">Health Plan Philippines, Inc.
                                        (HPPI)</option>
                                    ...
                                    <option value="Kaiser International Healthgroup, Inc.">Kaiser International
                                        Healthgroup, Inc.</option>
                                    ...
                                    <option value="Maxicare Healthcare Corporation">Maxicare Healthcare Corporation
                                    </option>
                                    ...
                                    <option value="Optimum Medical and Healthcare Services, Inc.">Optimum Medical and
                                        Healthcare Services, Inc.</option>
                                    <option value="Pacific (Blue) Cross Health Care, Inc.">Pacific (Blue) Cross Health
                                        Care, Inc.</option>
                                    <option value="Philhealth Care, Inc. (PhilCare)">Philhealth Care, Inc. (PhilCare)
                                    </option>
                                    <option value="Stotsenberg Healthcare System, Inc.">Stotsenberg Healthcare System, Inc.
                                    </option>
                                    <option value="Transnational Medical & Diagnostic Center, Inc. (TDMC)">Transnational
                                        Medical & Diagnostic Center, Inc. (TDMC)</option>
                                    <option value="Value Care Health Systems, Inc. (ValuCare)">Value Care Health Systems,
                                        Inc. (ValuCare)</option>

                                </select>

                                <div class="form-floating mt-1" id="paid_in_card_div" hidden>
                                    <input type="text" class="form-control" id="paid_in_card" name="z_paid_in_card"
                                        value="0">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="btn btn-outline-primary" for="success-outlined"><i
                                        class="fa fa-check-circle mx-2" aria-hidden="true"></i>Fully paid</label>

                                <input type="radio" class="btn-check" name="options-outlined" id="danger-outlined"
                                    autocomplete="off" disabled>
                                <label class="btn btn-outline-info" for="danger-outlined"><i
                                        class="fa fa-times-circle mx-2" aria-hidden="true"></i>Installment</label>

                                <input type="text" class="form-control mt-1" id="total_paid" name="total_paid"
                                    value="0" placeholder="Please enter amount paid" hidden>
                                <span class="text-danger error-text total_paid_error"></span>

                                <div class="form-group mt-1">
                                    <input type="text" class="form-control w-50" id="promo_code" name="promo_code"
                                        placeholder="promo code || for future function" disabled hidden>
                    ...
                    <div class="mx-auto w-75">
                        <p>Appointmnet receipt {{ $complete_summary->ro_id }} |
                            {{ date('M j, Y', strtotime($complete_summary->app_date)) }} |
                            {{ date('h:i A', strtotime($complete_summary->app_time)) }}</p>
                        ...
                        <div class="row w-75">
                            ...
                            <div class="col-lg">
                                <h4>&#8369;<span id="total_price_text" name="total_price_text"></span></h4>
                            </div>
                        ...
                        <div id="for_installment">
                            <div class="row w-75">
                                ...
                                <div class="col-lg">
                                    <h6>&#8369;<span id="payment_paid">0</span></h6>
                                </div>
                                <input hidden>
                            </div>
                            ...
                            <div class="row w-75">
                                ...
                                <div class="col-lg">
                                    <h6>&#8369;<span id="payment_balance">0</span></h6>
                                </div>
                                <input hidden>
                            </div>
                        </div>
                    ...
                    <div class="row w-50 mx-auto mt-4 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value=""
                                id="print_receipt_on_success">
                            <label class="form-check-label" for="print_receipt_on_success">
                                Print Receipt <i class="fa fa-print" aria-hidden="true"></i>
                            </label>
                        </div>

                        <button type="submit"class="btn btn-success float-lg-right" id="finish_appointment"
                            disabled>Finish appointment</button>
                        <p class="" id="input_exceeds" style="font-size: 13px" hidden>The sum of payments can not
                            be more than the total bill.</p>
                    </div>
                </div>
        ...
        <input type="text" value="{{ $toshow_equip_id }}" id="equipment_ids_final" name="equipment_ids_final"
            hidden>
        <input type="text" value="{{ $toshow_equip_value }}" id="equipment_values_final"
            name="equipment_values_final" hidden>
