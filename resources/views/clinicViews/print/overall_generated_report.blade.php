...
<body>
    ...
    @for ($x = 0; $x < count($selected_date); $x++)
        ...
        @if (count($daily_report[$x][0]) > 0 || count($daily_report[$x][1]) > 0 || count($daily_report[$x][2]) > 0 || count($daily_report[$x][3]) > 0 ||count($daily_report[$x][4]) > 0 || count($daily_report[$x][5]) > 0 || count($daily_report[$x][6]) > 0 || count($daily_report[$x][7]) > 0 || count($daily_report[$x][8]) > 0 || count($daily_report[$x][9]) > 0 || count($daily_report[$x][10]) > 0)

            <div class="row w-100 mx-auto border mt-3"></div>
            
            <div class="row d-flex justify-content-start mx-3 mt-5">
                <div class="col-auto">
                    <h6>{{ date('M d, Y', strtotime($selected_date[$x])) }} ({{ date('l', strtotime($selected_date[$x])); }})</h6>
                </div>
            </div>

            
            @if (count($daily_report[$x][0]) > 0 || count($daily_report[$x][1]) > 0 || count($daily_report[$x][2]) > 0 || count($daily_report[$x][3]) > 0 ||count($daily_report[$x][4]) > 0 || count($daily_report[$x][5]) > 0 || count($daily_report[$x][6]) > 0) {{-- APPOINTMENT TABLE --}}
            ...
            @if ( count($daily_report[$x][9]) > 0)  {{-- MOST USED MATERIAL --}}
                <div class="row w-75 mx-auto mt-3"> 
            ...
            @if ( count($daily_report[$x][10]) > 0)  {{-- MOST USED MATERIAL --}}
            <div class="row w-75 mx-auto mt-3"> 
    ...
    @if (count($complete_consumable_data) > 0 || count($complete_medicine_data) > 0 || count($complete_medicine_data) > 0) {{-- MATERIAL TABLE --}}
        <div class="row w-100 mx-auto border mt-3"></div>
        ...
        <div class="row w-75 mx-auto mt-3"> 
            ...
            <div class="row d-flex justify-content-start mx-3 mt-3">
                <div class="col-auto">
                    ...
                    <span class="text-muted" style="font-size: 12px;">from {{ date('M d, Y', strtotime($two_dates[0])) }} to {{ date('M d, Y', strtotime($two_dates[1])) }}</span>
                </div>
            </div>
