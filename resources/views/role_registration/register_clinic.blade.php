...
<body>
    ...
    <div class="container">
        <div class="shadow-lg p-3 mb-5 rounded registration_div">
            <div class="left">
                <img src="{{ URL::asset('images/mrjams/loginui.jpg') }}" alt="clinic">
            </div>
            ...
            <div class="right">
                <form action="{{route('clinic.settings.store')}}" method="POST" id="main_form">
                    ...
                    <input type="text" name="role" value="clinic" >
                    <div id="form_form">
                        ...
                        <div id="address">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="submit" class="form-control btn btn-primary" placeholder="Submit" name="submit">
                                    </div>
                                </div>
                            </div>
