        ...
        <div class="container-lg">
            <div class="row">
                ...
                <form action="{{ route('admin.message.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label"><b><i class="fa fa-users mr-1" aria-hidden="true"></i> Select
                                Receiver:</b></label>
                        <select class="form-select" aria-label="Default select example" id="messageSelect"
                            name="messageSelect">
                        ...
                        <label class="form-label mt-2"><b><i class="fa fa-bullhorn mr-1"
                                    aria-hidden="true"></i>Message/Announcement: </b></label>
