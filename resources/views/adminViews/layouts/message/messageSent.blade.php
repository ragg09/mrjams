                                        ...
                                        <div class="timeline">
                                            ...
                                            <div class="timeline-entry">
                                                <div class="timeline-stat">
                                                    ...
                                                    <div class="timeline-time">{{  date("h:i A", strtotime($adminSents->created_at)) }}</div>
                                                </div>
                                                <div class="timeline-label">
                                                    <h4 class="mar-no pad-btm"><a href="#" class="text-danger">MR. JAMS</a></h4>
                                                    <p style="font-size: 13px;">{{ date("M j, Y", strtotime($adminSents->created_at))}}</p>
                                                    <p><b>Receiver:</b> {{ $adminSents->receiver}}</p>
                                                    <p><b>{{ $adminSents->message }}</b></p>
                                                </div>
                                            </div>
                                            @endforeach
