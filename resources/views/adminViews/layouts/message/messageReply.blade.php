                    ...
                    <div class="row g-0">
                        <div class="py-2 px-4 border-bottom d-none d-lg-block">
                            <div class="d-flex align-items-center py-1">
                                <div class="position-relative" style="margin-left: 35px">
                                    <img src="{{ $sender->avatar }}" class="rounded-circle mr-1" alt="Sharon Lessman"
                                        width="40" height="40">
                                </div>
                                <div class="flex-grow-1 pl-0">
                                    <strong style="font-size: 18px;">{{ $sender->email }}</strong>
                                    <input class="form-control" id="sender" name="sender" type="text"
                                        value="{{ $sender->email }}" hidden>
                                    <div class="text-muted small" style="font-size: 16px;">
                                        <em>{{ date('M j, Y', strtotime($message->created_at)) }}</em></div>
                                </div>
                            ...
                            <div class="chat-messages p-4">
                                ...
                                <div class="chat-message-left pb-4">
                                    ...
                                    <div class="flex-shrink-1 rounded py-2 px-3 ml-3" style="background-color: #B3CDE0">
                                        <div class="font-weight-bold mb-1" id="sender" name="sender" type="text"
                                            style="color: black; font-size: 18px;">{{ $sender->email }}</div>
                                        <div id="messageBody" name="messageBody" style="color: black; font-size: 18px;">"
                                            {{ $message->message }} "</div>
                                    </div>
                                </div>
                        ...
                        <div class="flex-grow-0 py-3 px-4 border-top">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Type your message" id="messageReply"
                                    name="messageReply">
