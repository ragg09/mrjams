            ...
            <form action="/admin/clinicReg/{{ $clinicReg->id }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <p class="form-control" id="sender" name="sender" type="text">{{ $clinicReg->name }}</p>
                    </div>
                    <div class="col">
                        <label><b>Clinic Type</b></label>
                        <p class="form-control" id="sender" name="sender" type="text">
                            {{ $clinicType->type_of_clinic }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label><b>Clinic Phone#</b></label>
                        <p class="form-control" id="sender" name="sender" type="text">{{ $clinicReg->phone }}</p>
                    </div>
                    <div class="col">
                        <label><b>Clinic Telephone#</b></label>
                        <p class="form-control" id="sender" name="sender" type="text">{{ $clinicReg->telephone }}</p>
                    </div>
                </div>
                {{-- <br>
            <hr>
            <br> --}}
                <div class="row">
                    <div class="col">
                        ...
                        <p class="form-control" id="sender" name="sender" type="text">
                            {{ $clinicAdd->address_line_1 }} , {{ $clinicAdd->address_line_2 }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label><b>Clinic City & ZipCode</b></label>
                        <p class="form-control" id="sender" name="sender" type="text">{{ $clinicAdd->city }} ,
                            Zipcode: {{ $clinicAdd->zip_code }}</p>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                ...
                <div class="row mt-3">
                    <div class="col">
                        @if ($clinicReg->permit != null)
                            <label for="permit_id" class="form-label">
                                <h3>Business Permit</h3>
                            </label>
                            <input class="form-control" id="permit_id" name="permit_id" type="text"
                                value="{{ $clinicReg->permit_id }}" disabled>
                ...
                <div class="row">
                    <div class="col">
                        <button type="submit" id="acceptClinicReg" class="btn btn-primary"
                            style="font-weight: bold; color: black;"><i class="fa fa-check" aria-hidden="true"
                                style="margin-right: 5px;"></i>Accept</button>
                        <a id="deleteClinicReg" class="btn btn-danger" style="font-weight: bold; color: black;"><i
                                class="fa fa-times" aria-hidden="true" style="margin-right: 5px;"></i>Decline</a>
                    </div>
                </div>
            </form>
...
@section('extraScript')
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key={{ env('MAPPING_API_KEY') }}&callback=initMap&libraries=places">
    </script>
