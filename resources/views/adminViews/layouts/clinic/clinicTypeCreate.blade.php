            ...
            <div class="row">
                <div class="col">
                    <form action="{{ route('admin.clinicTypes.store') }}" method="POST">
                        @csrf
                        <div class="mb-2">
                            <label class="form-label" style="font-size: 18px;"><b>Clinic Type</b></label>
                    ...
                    <div class="mb-3">
                        ...
                        <button type="submit" id="updateClinic" class="btn btn-primary" id="clinicTypeSubmit"
                            name="clinicTypeSubmit"><b>Submit</b></button>
                    </form>
                </div>
            </div>
        </div>
