                        ...
                        <div class="card-content">
                           ...
                           <i class="fa fa-phone fa-2x" aria-hidden="true"></i>
                                ...
                                <form action="/admin/clinic/{{ $clinic->id }}" method="POST">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    <input type="text" class="form-control" id="clinicID"
                                        name="clinicID"value="{{ $clinic->id }}" hidden>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" id="clinicphone" name="clinicphone"
                                            value="{{ $clinic->phone }}" pattern="[0-9]+" required>
                                    </div>
                                    <div class="mb-2">
                                        <label class="form-label"><b>Telephone Number</b></label>
                                        <input type="text" class="form-control" id="clinictelephone"
                                            name="clinictelephone" value="{{ $clinic->telephone }}" pattern="[0-9]+"
                                            required>
                                    </div>
                                    <button type="submit" id="updateClinic" class="btn btn-primary"><b>Submit</b></button>
                                </form>
