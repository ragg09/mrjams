...
@section('content')
    ...
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            <div class="row">
                {{-- <h3><b>Message</b></h3> --}}
                <button class="btn btn-info mb-2" style="width: 200px; margin-right: 5px"><a
                        href="{{ route('admin.message.create') }}" style="color: black">Create</a></button>
                <button class="btn btn-warning mb-2" style="width: 200px"><a href="/admin/message/1"
                        style="color: black">Announcement</a></button>
                        ...
                        <tbody>
                            @foreach ($formatted_data_message as $adminMessages)
                                ...
                                <td>{{$clinics['telephone']}}</td> --}}
                                    ...
                                    <td><a href="/admin/message/{{ $adminMessages['id'] }}/edit"><button
                                                class="btn btn-primary" style="color: black;"><i class="fa fa-eye"
                                                    aria-hidden="true"></i> <b>Reply</b></button></a></td>
