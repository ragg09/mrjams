...
{{-- message: "SQLSTATE[23000]: Integrity constraint violation: 1451 Cannot delete or update a parent row: a foreign key constraint fails (`mrjams_system`.`billings`, CONSTRAINT `fk_billings_user_as_customer1` FOREIGN KEY (`user_as_customer_id`) REFERENCES `user_as_customer` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION) (SQL: delete from `user_as_customer` where `id` = 1)" --}}
...
<div class="body flex-grow-1 px-3">
    <div class="container-lg">
        <a href="" onclick="window.print()" ><i class="fa fa-print" aria-hidden="true"></i>Print</a>
        <div class="row">
