...
@section('content')
    ...
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            <div class="row">
                <button class="btn btn-info" style="width: 200px; margin-right: 5px"><a
                        href="{{ route('admin.clinicTypes.create') }}" id="createClinicType" style="color: black">Create
                        Clinic Type</a></button>
                <button class="btn btn-warning" style="width: 200px"><a href="{{ route('admin.clinicReg.index') }}"
                        style="color: black">Clinic Registration</a></button>
                        ...
                        <tbody>
                            @foreach ($clinic as $clinics)
                                <tr>
                                    ...
                                    <td><a href="/admin/clinic/{{ $clinics['id'] }}"><button class="btn btn-primary"
                                                style="margin-right: 5px; color: black;"><i class="fa fa-eye"
                                                    aria-hidden="true"></i> <b>View</b></button></a><a
                                            href="/admin/clinic/{{ $clinics['id'] }}/edit" class="btn btn-warning"
                                            id="editUser" style="color: black;"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i> <b>Edit</b></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
