    ...
    <form action="{{route('customer.appointment.store')}}" method="POST" id="main_form">
      @csrf
	          <div class="row">
                                ...
                                {{-- Appointment Information - Step 2 --}}
                                <div class="col-sm-4 login-sec">
                                    ...
                                    <div class="form-group" style="padding-top:40px;">
                                        ...
                                        <div class="form-group d-flex justify-content mt-1 mb-2" id="flatpickr" >
                                          <input type="text" class="flatpickr flatpickr-input active" placeholder="Select Date and Time.." id="accept_modal_flatpicker" name="datetime" style="width: 100%" disabled>
                                        </div>

                                        <button type="submit" class="btn btn-login float-right" id="appointment_b" disabled>Submit</button>
...
@section('jsScript')
    ...
    <script src="{{ URL::asset('js/customer/ServicePackage.js') }}"></script>  
